...
const runAllScrapers = async () => {
  const newNotices = [];
  newNotices.push(...(await scrapeAndSaveNotices(await scrapeCSE())));
  newNotices.push(...(await scrapeAndSaveNotices(await scrapeSEE())));
  newNotices.push(...(await scrapeAndSaveNotices(await scrapeAllHome())));
